    ...
    return (
        ...
        <DataTable style={styles.container}>
          ...
          <DataTable.Row style={styles.tableRow2}>
            <DataTable.Cell style={{minWidth:114, maxWidth: 111, paddingRight: 7}}>Attrition_09_12_2023</DataTable.Cell>
          ...
          <DataTable.Row style={styles.tableRow1}>
            <DataTable.Cell style={{minWidth:114, maxWidth: 111, paddingRight: 7}}>Maintenance_09_12_2023</DataTable.Cell>
          ...
          <DataTable.Row style={styles.tableRow2}>
            <DataTable.Cell style={{minWidth:114, maxWidth: 111, paddingRight: 7}}>Refills_09_12_2023</DataTable.Cell>
            <DataTable.Cell style={{minWidth:84, maxWidth: 84, paddingRight: 10}}>automated</DataTable.Cell>
            <DataTable.Cell>20</DataTable.Cell>
            <DataTable.Cell>19462</DataTable.Cell>
          </DataTable.Row>
          <DataTable.Row style={styles.tableRow1}>
            <DataTable.Cell style={{minWidth:114, maxWidth: 111, paddingRight: 7}}>NeedsRetest_09_12_2023</DataTable.Cell>
            <DataTable.Cell style={{minWidth:84, maxWidth: 84, paddingRight: 10}}>manual</DataTable.Cell>
